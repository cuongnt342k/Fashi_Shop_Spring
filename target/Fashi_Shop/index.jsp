...
<section class="hero-section">
    <div class="hero-items owl-carousel">
        <div class="single-hero-items set-bg" data-setbg="<c:url value="/template/img/hero-1.jpg"/>">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                        <span>Bag,kids</span>
        ...
        <div class="single-hero-items set-bg" data-setbg="<c:url value="/template/img/hero-2.jpg"/>">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                        <span>Bag,kids</span>
...
<section class="women-banner spad">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-3">
                <div class="product-large set-bg" data-setbg="<c:url value="/template/img/products/women-large.jpg"/>">
                    <h2>Women’s</h2>
            ...
            <div class="col-lg-8 offset-lg-1">
                ...
                <div class="product-slider owl-carousel">
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="<c:url value="/template/img/products/women-1.jpg"/>" alt="">
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="<c:url value="/template/img/products/women-2.jpg"/>" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="<c:url value="/template/img/products/women-3.jpg"/>" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="<c:url value="/template/img/products/women-4.jpg"/>" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
...
<section class="deal-of-week set-bg spad" data-setbg="<c:url value="/template/img/time-bg.jpg"/>">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="product-slider owl-carousel">
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="<c:url value="/template/img/products/man-1.jpg"/>" alt="">
                            <div class="sale">Sale</div>
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="<c:url value="/template/img/products/man-2.jpg"/>" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="<c:url value="/template/img/products/man-3.jpg"/>" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="<c:url value="/template/img/products/man-4.jpg"/>" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
            ...
            <div class="col-lg-3 offset-lg-1">
                <div class="product-large set-bg m-large" data-setbg="<c:url value="/template/img/products/man-large.jpg"/>">
                    <h2>Men’s</h2>
                    <a href="#">Discover More</a>
                </div>
            </div>
...
<div class="instagram-photo">
    <div class="insta-item set-bg" data-setbg="<c:url value="/template/img/insta-1.jpg"/>">
        <div class="inside-text">
            <i class="ti-instagram"></i>
            <h5><a href="#">colorlib_Collection</a></h5>
        </div>
    </div>
    <div class="insta-item set-bg" data-setbg="<c:url value="/template/img/insta-2.jpg"/>">
        <div class="inside-text">
            <i class="ti-instagram"></i>
            <h5><a href="#">colorlib_Collection</a></h5>
        </div>
    </div>
    <div class="insta-item set-bg" data-setbg="<c:url value="/template/img/insta-3.jpg"/>">
        <div class="inside-text">
            <i class="ti-instagram"></i>
            <h5><a href="#">colorlib_Collection</a></h5>
        </div>
    </div>
    <div class="insta-item set-bg" data-setbg="<c:url value="/template/img/insta-4.jpg"/>">
        <div class="inside-text">
            <i class="ti-instagram"></i>
            <h5><a href="#">colorlib_Collection</a></h5>
        </div>
    </div>
    <div class="insta-item set-bg" data-setbg="<c:url value="/template/img/insta-5.jpg"/>">
        <div class="inside-text">
            <i class="ti-instagram"></i>
            <h5><a href="#">colorlib_Collection</a></h5>
        </div>
    </div>
    <div class="insta-item set-bg" data-setbg="<c:url value="/template/img/insta-6.jpg"/>">
        <div class="inside-text">
            <i class="ti-instagram"></i>
            <h5><a href="#">colorlib_Collection</a></h5>
        </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="single-latest-blog">
                    <img src="<c:url value="/template/img/latest-1.jpg"/>" alt="">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-latest-blog">
                    <img src="<c:url value="/template/img/latest-2.jpg"/>" alt="">
                    <div class="latest-text">
                        <div class="tag-list">
                            <div class="tag-item">
                                <i class="fa fa-calendar-o"></i>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-latest-blog">
                    <img src="<c:url value="/template/img/latest-3.jpg"/>" alt="">
                    <div class="latest-text">
                        <div class="tag-list">
                            <div class="tag-item">
                                <i class="fa fa-calendar-o"></i>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="single-benefit">
                        <div class="sb-icon">
                            <img src="<c:url value="/template/img/icon-1.png"/>" alt="">
                        </div>
                        <div class="sb-text">
                            <h6>Free Shipping</h6>
                ...
                <div class="col-lg-4">
                    <div class="single-benefit">
                        <div class="sb-icon">
                            <img src="<c:url value="/template/img/icon-2.png"/>" alt="">
                        </div>
                        <div class="sb-text">
